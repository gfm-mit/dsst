...
def get_loaders(device=None, task=None, shuffle=True):
  ...
  train_loader = torch.utils.data.DataLoader(train_data, batch_size=1000, shuffle=shuffle, collate_fn=lambda x: x)
  val_loader = torch.utils.data.DataLoader(val_data, batch_size=1000, shuffle=shuffle, collate_fn=lambda x: x)
  calibration_loader = torch.utils.data.DataLoader(calibration_data, batch_size=1000, shuffle=True, collate_fn=lambda x: x)
  test_loader = torch.utils.data.DataLoader(test_data, batch_size=1000, shuffle=shuffle, collate_fn=lambda x: x)
