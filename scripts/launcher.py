...
def main():
  ...
  if args.bitmap:
    ...
    train_loader, val_loader, calibration_loader, test_loader = etl.torch.testonly.get_loaders(device=args.device, task=args.task, batch_size=1000)
  if args.coef:
    # check coefficients
